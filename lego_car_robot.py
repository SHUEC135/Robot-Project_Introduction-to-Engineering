...
TURN_VELOCITY = 10000    # Speed when rotating

async def main():
    # Pair motors for the car (left motor on E, right motor on F)
    ...
    while True:
        # Read distance from sensor on port A
        dist = distance_sensor.distance(port.A)
